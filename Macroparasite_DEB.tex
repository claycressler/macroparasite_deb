...
\hlcom{##------------------}
\hlcom{## total ingestion for balb/c = 7.86 g food/day; black6 = 6.54}
\hlcom{## imax is between 0.15-0.4 g food/g mouse}
\hlcom{## rho = 4; it is 1/mean transit time, which is approx 6 hours}
\hlcom{## balb/c theta = 3.93 g lean/g fat; black6 = 3.5 g lean/g fat}
\hlcom{## ui = 20 days (for CD4 cell)}
\hlcom{## mC = 11 hours (half-life for neutrophils, 60-70% of standing immune}
\hlcom{## defense; 60 day lifespan for lymphocytes, 40% of standing immune}
\hlcom{## defense)}
\hlcom{## balb/c = 1.5 g at birth, black6=1.23g at birth,}
\hlcom{## balb/c = 664 days lifespan, black6=896 days lifespan}
\hlcom{## estimate of digestive assimilation efficiency=85%}
\hlcom{## assume all other conversion efficiencies = 1}
\hlcom{## weight of a lymphocyte 2.15e-10 g}
\hlcom{## maintenance rate of Mus musculus = 0.0065 (from Kooijman 2009, p. 212)}
\hlcom{## standing defense balb/c @8 weeks = 1.25e-3 g WBC mass, weight 25.4 g}
\hlcom{## standing defense black6 @8 weeks = 1.07e-3 g WBC mass, weight 23.7 g}
\hlcom{## 0.82}
...
\hlcom{## Run for 500 days}
\hlstd{times} \hlkwb{<-} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{500}\hlstd{,} \hlnum{0.1}\hlstd{)}
